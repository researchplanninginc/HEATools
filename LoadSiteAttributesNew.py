# ---------------------------------------------------------------------------
# NAME: LoadSiteAttributesNew.py
# Version: 2.0 (ArcGIS 10.2)
# Author: Research Planning, Inc.
#
# Usage: LoadSiteAttributesNew <input_analysis_database> <input_feature_layer> <input_habitat> 
...
try:
    ...
    attr_exist = 0
    if habType=="#":
        habType = "-not applicable-"
    else:
        attr_exist = 1
    if conType=="#":
        conType = "-not applicable-"
    else:
        attr_exist = 1
    if remStat=="#":
        remStat = "-not applicable-"
    else:
        attr_exist = 1
    if subSite=="#":
        subSite = "-not applicable-"
    else:
        attr_exist = 1
    if depth=="#":
    ...
    arcpy.AddError("\n*** ERROR *** " + inLayer + ": No attributes have been selected. Though specified as optional, at least one must be selected.\n")
    print "\n*** ERROR *** " + inLayer + ": No attributes have been selected. Though specified as optional, at least one must be selected.\n"
